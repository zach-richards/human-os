...
impl TrayIcon {
    ...
    */
    ...
    pub fn run(&self, score: f32) {
        ...
        self_clone.update_icon(&mut ind, &base_icon, Self::get_color_from_score(score, &self.colors));
    }
...
impl TrayIconForClosure {
    fn update_icon(&self, indicator: &mut AppIndicator, base_icon: &PathBuf, color: (u8, u8, u8)) {
